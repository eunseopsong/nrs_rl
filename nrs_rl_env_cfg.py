...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            command_velocity_hard_stop_decay=0.95,
            command_velocity_max_mm_s=42.0,
            force_filter_beta=0.12,
            force_spike_delta_n=0.70,
            force_spike_hold_steps=10,
            force_spike_velocity_decay=0.96,
            ...
            force_normal_release_kp_mm_per_n=0.80,
            force_normal_ki_mm_per_n_s=8.00,
            force_normal_max_step_mm=5.00,
            force_normal_retract_max_step_mm=6.00,
            force_normal_offset_limit_mm=45.0,
            force_total_normal_delta_limit_mm=45.0,
            force_normal_deadband_n=0.15,
            force_band_min_n=9.0,
            force_band_max_n=11.0,
            force_band_index_rate_limit=3.0,
            force_band_saturated_min_n=9.0,
            force_band_low_speed_scale=0.25,
            force_band_high_speed_scale=0.45,
