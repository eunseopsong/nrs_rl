...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            force_normal_release_kp_mm_per_n=0.55,
            force_normal_ki_mm_per_n_s=2.80,
            force_normal_max_step_mm=2.00,
            ...
            force_band_low_speed_scale=0.50,
