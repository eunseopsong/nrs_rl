...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            force_filter_beta=0.10,
            force_spike_delta_n=0.35,
            force_spike_hold_steps=20,
            force_spike_velocity_decay=0.55,
            ...
            force_normal_release_kp_mm_per_n=1.00,
            force_normal_ki_mm_per_n_s=6.00,
            force_normal_max_step_mm=5.00,
            force_normal_retract_max_step_mm=2.00,
            force_normal_offset_limit_mm=90.0,
            force_total_normal_delta_limit_mm=90.0,
            force_normal_deadband_n=0.20,
            force_band_min_n=9.0,
            force_band_max_n=11.0,
            force_band_index_rate_limit=5.0,
            force_band_saturated_min_n=8.0,
            force_band_low_speed_scale=0.55,
            force_band_high_speed_scale=0.25,
            force_band_hold_progress=False,
            force_severe_underforce_n=7.0,
            force_severe_underforce_hold_progress=True,
            ...
            path_command_max_z_step_mm=12.0,
