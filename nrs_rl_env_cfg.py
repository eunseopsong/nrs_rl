...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            path_tracking_slowdown_start_mm=3.0,
            path_tracking_stop_mm=12.0,
            path_tracking_min_rate_scale=0.25,
            path_projection_window=160,
            path_projection_max_advance_index=12.0,
            path_lookahead_min_index=2.0,
            path_lookahead_max_index=36.0,
            path_lookahead_time_s=0.04,
            path_command_max_xy_step_mm=0.0,
            path_command_max_z_step_mm=4.0,
