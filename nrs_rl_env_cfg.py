...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            target_mrr_n_mm_s=800.0,
            speed_action_scale=0.15,
            base_index_rate=16.0,
            min_index_rate=1.0,
            max_index_rate=32.0,
            progress_rate_ema_beta=0.2,
            force_eps_n=1.0,
            force_tracking_ready_ratio=0.8,
            min_force_rate_scale=0.05,
            force_z_integral_gain_mm_per_n_s=0.18,
            force_z_release_gain_mm_per_n_s=0.28,
            force_z_deadband_n=1.0,
            force_z_max_delta_mm=0.02,
            force_z_offset_min_mm=-6.0,
            force_z_offset_max_mm=0.5,
