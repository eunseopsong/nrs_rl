...
class ActionsCfg:
    arm_action = local_action.AdmittanceControlActionCfg(
        ...
        integration=local_action.ActionIntegrationCfg(
            ...
            command_velocity_max_delta_up_mm_s=1.0,
            ...
            force_velocity_compensation=0.30,
            ...
            force_normal_release_kp_mm_per_n=0.62,
            force_normal_ki_mm_per_n_s=3.20,
            force_normal_max_step_mm=2.30,
            ...
            force_band_saturated_min_n=8.2,
            force_band_low_speed_scale=0.35,
